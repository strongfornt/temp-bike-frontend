    ...
    return (
        <section className="py-10">
            <div className="max-w-7xl mx-auto px-4">
                <h2 className="text-3xl md:text-4xl font-bold text-center text-primary my-5 md:my-8">Why Choose Us?</h2>
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        },
                        {
                            ...
                            benefits: ["Full coverage", "Easy claims process", "Expert support"],
                        },
                        {
                            icon: <SyncOutlined />,
                            title: "Easy Returns",
                            ...
                            benefits: ["No questions asked", "Free return shipping", "Quick refunds"],
                        },
                    ].map((item, index) => (
                        <div
                            key={index}
