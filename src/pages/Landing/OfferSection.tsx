    ...
    return (
        <section className="py-10" >
            <div className="max-w-7xl mx-auto px-4">
                <h2 className="text-3xl md:text-4xl font-bold text-center text-primary my-5 md:my-8">Exclusive Special Deals</h2>
                    ...
                    {[
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-2xl font-bold text-[#f97316]">{deal.title}</h3>
                                <span className="text-xl font-semibold text-primary">{deal.discount}</span>
                            </div>
                            <p className="text-gray-300 mb-4">{deal.description}</p>
                            <div className="bg-gray-700 p-3 rounded-lg mb-4">
                                <p className="text-gray-300">
                                    Use code: <span className="font-bold text-[#f97316]">{deal.code}</span>
                                </p>
                            </div>
                            ...
                            <Button className="mt-4 bg-primary text-white py-2 rounded-lg hover:bg-[#2563eb] transition-colors duration-300">
                                Claim Offer
                            </Button>
                        </div>
                    ))}
