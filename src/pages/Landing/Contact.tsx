        ...
        <div className="grid grid-cols-1 mt-8 lg:grid-cols-2 gap-12">
          <div className="space-y-6">
            <div className="relative">
              ...
              <div className="relative border border-primary/30 p-6 rounded-lg shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <p className="flex items-center">
                    <EnvironmentOutlined className="mr-2" /> 123 Neon Street,
                    Glow City, GL 12345
                  </p>
                </div>
              </div>
            ...
            <div className="border border-primary/30 p-6 rounded-lg shadow-lg">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-primary/30 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                />
              </div>
              <div>
                <label
