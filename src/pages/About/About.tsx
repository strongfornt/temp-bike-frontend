...
const teamMembers = [
  { name: "Jane Doe", role: "Founder & CEO", image: "https://pics.craiyon.com/2024-09-12/XOKa-4cJTACP9pe3jRWNrg.webp" },
  { name: "John Smith", role: "Head Mechanic", image: "https://pics.craiyon.com/2024-09-12/XOKa-4cJTACP9pe3jRWNrg.webp" },
  { name: "Emily Brown", role: "Community Manager", image: "https://pics.craiyon.com/2024-09-12/XOKa-4cJTACP9pe3jRWNrg.webp" },
  { name: "Mike Johnson", role: "Bike Architect", image: "https://pics.craiyon.com/2024-09-12/XOKa-4cJTACP9pe3jRWNrg.webp" },
];

const timelineData = [
  { year: "2024", event: "Launched the Bike Shop website with a fully responsive design." },
  { year: "2023", event: "Expanded inventory to include electric bikes and accessories." },
  { year: "2022", event: "Partnered with local suppliers for better bike quality and pricing." },
  { year: "2021", event: "Opened the first physical store and started online sales." },
  { year: "2020", event: "Started the Bike Shop business with a small collection of road bikes." },
];


const stats = [
  { icon: <TeamOutlined className="text-4xl mb-4 text-primary" />, value: "10k+", label: "Cycling Community" },
  { icon: <EnvironmentOutlined className="text-4xl mb-4 text-primary" />, value: "2", label: "Urban Hubs" },
  { icon: <ClockCircleOutlined className="text-4xl mb-4 text-primary" />, value: "18", label: "Years Rolling" },
  { icon: <RocketOutlined className="text-4xl mb-4 text-primary" />, value: "200+", label: "Events Hosted" },
];
const About = () => {
  return (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mt-8 md:mt-12">
            <div className="space-y-6 text-lg">
              <p className="text-gray-300 leading-relaxed">
                Founded in 2005, Cycle Haven has been revolutionizing urban mobility through sustainable cycling solutions.
                What started as a small repair shop has pedaled its way to becoming a community hub for cycling enthusiasts.
              </p>
              <div className="p-6 rounded-xl border border-primary/20 overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
                <p className="text-gray-300 italic">
                  "We believe every ride tells a story. Our passion is to make yours unforgettable."
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mt-8 md:mt-12">
            <div className="p-8 border border-primary/30 rounded-lg hover:border-primary/40 overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
              ...
              <p className="text-gray-300 leading-relaxed">
                To create car-free cities by 2040 through accessible cycling infrastructure and community-driven
                initiatives that make biking the preferred mode of urban transportation.
              </p>
            </div>
            ...
            <div className="p-8 border border-primary/30 rounded-lg hover:border-primary/40 overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
              ...
              <p className="text-gray-300 leading-relaxed">
                Empower individuals and communities through cycling by providing innovative solutions,
                educational programs, and advocacy for bike-friendly urban development.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Timeline mode="alternate" className="!mt-8 custom-timeline">
            {timelineData.map((milestone, index) => (
              <Timeline.Item key={index} label={<span className="text-2xl md:text-3xl font-bold text-primary">{milestone.year}</span>}>
                <div className="p-6 rounded-xl border border-primary/20 hover:border-primary/40 overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 ">
                  <p className="text-gray-300 leading-relaxed text-lg md:text-2xl">{milestone.event}</p>
                </div>
              </Timeline.Item>
            ))}
          </Timeline>
      ...
      <section className="py-8 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-xl mb-8 text-gray-300 leading-relaxed mt-8 md:mt-12">
            Join our cycling revolution and experience the freedom of two wheels!
          </p>
          <Link to={'/contact'}
