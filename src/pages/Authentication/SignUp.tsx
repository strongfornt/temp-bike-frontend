        ...
        <div className="bg-[#f3f4f6ec] p-5 rounded-xl space-y-2 md:space-y-5 w-full md:w-[480px] drop-shadow-lg">
          ...
          >
            ...
            <Form.Item
              ...
              className="space-x-2 font-medium text-xs"
              rules={[
                {
                  validator: (_, value) =>
                    value
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-5 text-black font-medium">
            <Button
              ...
              size="large"
              className="py-1 pointer-events-none cursor-not-allowed md:py-3 text-xs md:text-sm border border-gray-400 rounded-md w-full flex justify-center items-center gap-3 hover:bg-black hover:text-white hover:border-black duration-300"
            >
              Sign in with Google
            </Button>
            <Button
