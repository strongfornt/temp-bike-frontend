...
const Footer = () => {
  return (
    <footer className="bg-[#000001]/60">
      <section className="pt-5 md:pt-10 lg:pt-14  max-w-7xl mx-auto">
        <div className="container p-6 mx-auto">
          <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5 px-6">
              <Link
                to="/"
                className="text-xl mb-2  md:text-3xl lg:text-4xl font-bold text-primary cursor-pointer flex items-center"
              >
                 <span className="">
              ...
              <p className="max-w-sm  text-gray-400">
                Load up and head out. Explore the route less travelled or
                accelerate your daily routine with one of these rugged,
                versatile e-bikes.
              </p>
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                  <h3 className="text-gray-300 font-medium uppercase">
                    Products
                  </h3>
                  <a
                    href="#"
